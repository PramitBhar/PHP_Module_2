...
class User
{
  ...
  //This array contains subject name and marks as a pair.
  public $final_marks_and_subject_pair = [];
  /**
  ...
  */
  public function createTableFomatter(string $pair)
  {
    ...
    array_push($final_marks_and_subject_pair,$keyvalue);
    $key = trim($keyvalue[0]);
  ...
  /**
   * This function is used to get the subjec name and marks as a key value pair.
   *
   * @return type: array
   */
  public function pdfTableGenerator(){
    return $final_marks_and_subject_pair;
  }
}
?>
