...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (!empty(htmlspecialchars($fullname))) {
		...
		// Below conditions are checking for if both the input field is Properly validate pattern or not,if first input field is properly validate and second input field is not or viceversa.  
			...
			<div class="form-contents">
				<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
					...
					<div class="form-fields">
						...
						<input type="text" class="form-input-fields" placeholder="First Name" value="<?php echo $fname ?>" name="fname" maxlength="35">
					...
					<div class="form-fields">
						<label class="form-fields-heading"> <span class="warning-message">*</span>Last Name:</label>
						<input type="text" class="form-input-fields" placeholder="Last Name" value="<?php echo $lname ?>" name="lname" maxlength="35">
						<p class="warning-message">
					...
					<div class="form-fields">
						...
						<input type="text" class="form-input-fields" placeholder="Full Name" name="fullname" value="<?php if ($message != "") echo htmlspecialchars($fullname); ?>" disabled>
					</div>
